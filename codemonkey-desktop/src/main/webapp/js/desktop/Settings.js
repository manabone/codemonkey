            ...
            store: new Ext.data.TreeStore({
                ...
                root: {
                    ...
                    children:[
                        ...
                        child('/css/desktop/wallpapers/Blue-Sencha.jpg'),
                        child('/css/desktop/wallpapers/Dark-Sencha.jpg'),
                        child('/css/desktop/wallpapers/Wood-Sencha.jpg'),
                        child('/css/desktop/wallpapers/blue.jpg'),
                        child('/css/desktop/wallpapers/desk.jpg'),
                        child('/css/desktop/wallpapers/desktop.jpg'),
                        child('/css/desktop/wallpapers/desktop2.jpg'),
                        child('/css/desktop/wallpapers/sky.jpg')
                    ]
                }
            })
        });
