...
//	public Page<AbsEntity> page(Class<?> clazz , int pageIndex, int pageSize , String query , Object... values ){
//		
//		String sql = buildQuerySql(clazz , query);
//		
//		sql += getPageCondition(pageIndex, pageSize);
//		
//		SqlRowSet rowSet = jdbcTemplate.queryForRowSet(sql , values);
//		
//		List<AbsEntity> list = buildResultList(clazz , rowSet);
//		
//		long totalCount = count(clazz , query , values);
//		
//		return new Page<AbsEntity>(list, totalCount);
//		
//	}
